...
-- CreateIndex
CREATE INDEX "UserTranslation_userId_idx" ON "public"."UserTranslation"("userId");

-- CreateIndex
CREATE INDEX "UserTranslation_languageId_idx" ON "public"."UserTranslation"("languageId");
...
-- CreateIndex
CREATE INDEX "Device_isActive_idx" ON "public"."Device"("isActive");
...
-- CreateIndex
CREATE INDEX "Permission_method_idx" ON "public"."Permission"("method");
...
-- CreateIndex
CREATE INDEX "ProductTranslation_languageId_idx" ON "public"."ProductTranslation"("languageId");
...
-- CreateIndex
CREATE INDEX "CategoryTranslation_languageId_idx" ON "public"."CategoryTranslation"("languageId");
...
-- CreateIndex
CREATE INDEX "SKU_price_idx" ON "public"."SKU"("price");

-- CreateIndex
CREATE INDEX "SKU_stock_idx" ON "public"."SKU"("stock");
...
-- CreateIndex
CREATE INDEX "BrandTranslation_brandId_idx" ON "public"."BrandTranslation"("brandId");

-- CreateIndex
CREATE INDEX "BrandTranslation_languageId_idx" ON "public"."BrandTranslation"("languageId");

-- CreateIndex
CREATE INDEX "BrandTranslation_deletedAt_idx" ON "public"."BrandTranslation"("deletedAt");

-- CreateIndex
CREATE UNIQUE INDEX "BrandTranslation_brandId_languageId_key" ON "public"."BrandTranslation"("brandId", "languageId");
...
-- CreateIndex
CREATE INDEX "ProductSKUSnapshot_orderId_idx" ON "public"."ProductSKUSnapshot"("orderId");

-- CreateIndex
CREATE INDEX "ProductSKUSnapshot_productId_idx" ON "public"."ProductSKUSnapshot"("productId");
...
-- CreateIndex
CREATE INDEX "Order_paymentId_idx" ON "public"."Order"("paymentId");
...
-- CreateIndex
CREATE INDEX "ReviewMedia_type_idx" ON "public"."ReviewMedia"("type");

-- CreateIndex
CREATE INDEX "PaymentTransaction_gateway_idx" ON "public"."PaymentTransaction"("gateway");

-- CreateIndex
CREATE INDEX "PaymentTransaction_transactionDate_idx" ON "public"."PaymentTransaction"("transactionDate");

-- CreateIndex
CREATE INDEX "PaymentTransaction_accountNumber_idx" ON "public"."PaymentTransaction"("accountNumber");
...
-- CreateIndex
CREATE INDEX "Websocket_userId_idx" ON "public"."Websocket"("userId");
